...
<div class="col-md-3">
    ...
    <div class="list-group">
        ...
        <a href="buscarFuncionario.jsp" class="list-group-item">Buscar Funcionário</a>
        ...
        <a href="relatorioTopBuyers.jsp" class="list-group-item">Clientes que mais compram</a>
        <a href="relatorioCompraPeriodo.jsp" class="list-group-item">Compras por período</a>
