        ...
        <div class="container">
            <div class="row">
                ...
                <div class=" col-sm-6">
                    ...
                    <form class="form-horizontal" id="form" method="POST" action="../Marcas?action=cadastrar" >
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>1</td><td>Marvel</td><td><span class="glyphicon glyphicon-pencil"></span></td><td><span class="glyphicon glyphicon-trash"></span></td>
