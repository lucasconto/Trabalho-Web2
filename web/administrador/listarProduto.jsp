                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <select name="escolha" class="form-control">
                                    <option value="titulo" ${escolha == 'titulo' ? 'selected' : ''}>Titulo</option>
                                    <option value="autor" ${escolha == 'autor' ? 'selected' : ''}>Autor</option>
                                    <option value="genero" ${escolha == 'genero' ? 'selected' : ''}>Genero</option>
                                </select>
                            </div>
                            <div class="col-md-7">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        ...
                                        <form action="./Produtos?action=valterarp&id=${produto.idProduto}" method="post" style="display: inline">
                                            <a href="#" onclick="this.parentNode.submit();">
                                        ...
                                        <a href="" data-toggle="modal" data-target="#exampleModal" data-escolha="${escolha}" data-str="${str}" data-idproduto="${produto.idProduto}">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="exampleModalLabel">Exclusao de Produto</h4>
                            </div>
            ...
            <script>
                                                $(function () {
                                                    ...
                                                    $('#exampleModal').on('show.bs.modal', function (event) {
                                                        ...
                                                        var modal = $(this);
                                                        modal.find('#produto-id').val(idProduto);
